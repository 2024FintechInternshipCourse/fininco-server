...
import static com.fininco.finincoserver.exchange.entity.ExchangeType.SELL;

@Slf4j
@Component
@RequiredArgsConstructor
public class ExchangeSellTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        List<ExchangeReservation> reservations = exchangeReservationRepository.findByStatusAndTargetRateAndType(PENDING, currentRate.getSellCurrency(), SELL);
